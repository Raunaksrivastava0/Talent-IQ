...
import { ArrowRightIcon,Check, CheckIcon,Code2Icon, SparklesIcon,UsersIcon, Video, VideoIcon, ZapIcon } from "lucide-react"
import { SignInButton} from "@clerk/clerk-react"

function HomePage() {

    //fetch some data using tanstack
       ...
       <div className="max-w-7xl mx-auto px-4 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            {/*STATS*/}
            <div className="stats-vertical lg:stats-horizontal bg-base-100 shadow-lg">
              <div className="stat">
          ...
          {/*FEATURE 3*/}
           <div className="card bg-base-100 shadow-xl">
            <div className="card-body items-center text-center">
              ...
              <p className="text-base-content/70">
                Share your screen, discuss solutions, learn from each other in real-time
              </p>
            </div>
          </div>
       </div>
